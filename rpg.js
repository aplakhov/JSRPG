rpg = {
    ...
    mirror: {
        name: "Зеркало",
        inventoryImg: "Inventory/mirror",
        message: "О, зеркало. Буду отслеживать свой прогресс в бодибилдинге.",
        use_message: [
            "Как же я хорош!",
            "Какой красавец!",
            "Это что, прыщик? Ну вот.",
            "Одно ясно, я точно не вампир.",
            "Зеркало наверняка волшебное. Но пока непонятно, в чём волшебство.",
        ]
    },
    pick: {
        type: "sword",
        quality: 2,
        name: "Гномья кирка",
        message: "Не получится стать магом, пойду в шахтёры",
        reject: "Кирка у меня уже есть",
        equipImg: "Equip/pick",
        inventoryImg: "Inventory/pick",
        use_message: [
            "Поищем золото?",
            'А ударение в слове "кирка" на какой слог?',
            "Бойтесь меня, я маньяк с киркой!"
        ]
    },    
    dynamite: {
    ...
    spider_egg: {
        name: "Паучье яйцо",
        message: "А вдруг их можно приручить, пока они маленькие?",
        multiple: true,
        inventoryImg: "Inventory/spider_egg",
        use_message: [
            "Я не паук",
            "Я не буду это высиживать",
            "И есть я это тоже не буду",
            "Фу, ну и гадость"
        ]
    }
}
