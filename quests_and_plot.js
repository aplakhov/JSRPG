const characters = {
    ...
    abyss_spider: {
        text: "Кто-то из бездны",
        addText: "",
        portrait: "Dialogs/abyss_spider",
        getGreeting: () => { return "n!! = n(n-2)(n-4)... <> (n!)!" }
    }
};
...
const quests = {
    ...
    dungeon_abyss_spider: {
        map: "dungeon_map",
        character: "abyss_spider",
        introDialog: [
            ["", "n!! = n(n-2)(n-4)... != (n!)!", [1, 2]], // 0
            ["Я тебя не понимаю. Можешь выражаться как-то попроще?", "0", []], // 1
            ["Незачем так ругаться. Как ещё мне было привлечь твое внимание?", "х = 0 ∨ x < 0", [3, 1]], // 2
            ["И вовсе я не ноль. И вообще, прекрати меня оскорблять! Дело есть.", "∃f: f(x)>0?", [4, 1]], // 3
            ["Да, ты не поверишь, но у меня и правда есть кое-что, что тебе важно.", "i ∉ R", [5, 1]], // 4
            ["А вот и не воображаемое. Смотри.", "....", []], // 5
        ]
    },    
}
